<form wire:submit="save" x-on:specialization-added.window="$dispatch('close')" class="p-6">
    @csrf
    ...
    <div class="mt-6">
        <x-input-label for="specialization_name" value="{{ __('Nauja gydytojo specializacija') }}"/>
    ...
    <div class="mt-6">
        <x-input-label for="specialization_description" value="{{ __('Specialization aprašymas') }}"/>
