                                ...
                                >
                                    ...
                                    >
                                        ...
                                        >
                                            ...
                                            <div
                                                class="inline-flex h-6 border-r"
                                            ></div>
                                            <button
                                                type="button"
                                                class="inline-flex cursor-pointer items-center rounded-lg p-1 leading-none transition duration-100 ease-in-out hover:bg-gray-200"
        ...
        function app() {
            return {
                ...
                isAppointmentAvailable(date) {
                    ...
                    return APPOINTMENT_DAYS.includes(
                ...
                selectAppointmentDay(date) {
                    this.selectedDayAppointments = this.filterAppointments(
                        new Date(this.year, this.month, date, 12),
                    );
                },
