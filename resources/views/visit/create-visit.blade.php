@php
    ...
    $appointments = DoctorAppointmentSlot::where('doctor_id', $id)->with('doctor.specialization')->with('doctor.user')->where('start_time', '>=', date('Y-m-d H:i', strtotime('now')))->where('is_available', false)->orderBy('start_time', 'ASC')->get();
                                ...
                                <div class="p-1.5 min-w-full inline-block align-middle">
                                    <div class="overflow-hidden">
                                        <table class="min-w-full divide-y divide-gray-200">
                                            ...
                                            <template x-for="(appointment, index) in selectedDayAppointments" :key="index">
                                                <tr class="hover:bg-gray-100">
                                                    <td x-text="appointment.doctor.user.name" class="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-800">
                                                    </td>
                                                    <td x-text="appointment.doctor.specialization.name" class="px-6 py-4 whitespace-nowrap text-sm text-gray-800">
                                                    </td>
                                                    <td x-text="appointment.start_time" class="px-6 py-4 whitespace-nowrap text-sm text-gray-800">
                                                    </td>
                                                    <td class="px-6 py-4 whitespace-nowrap text-start text-sm font-medium">
                                                        <button @click="openModal(appointment.id)" type="button"
